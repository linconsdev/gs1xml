...
class Converter {
    ...
    public static function XMLtoPHP(string $xml) {
        $xmlObject = simplexml_load_string($xml); 
        return self::simpleXmlToArray($xmlObject);
    }

    private static function simpleXmlToArray($xml, $options = array()) {
        $defaults = array(
        ...
        foreach ($namespaces as $prefix => $namespace) {
            ...
            foreach ($xml->children($namespace) as $childXml) {
                ...
                $childArray = self::simpleXmlToArray($childXml, $options);
    ...
    private static function PHPtoXML(array $document) {
